...
package com.davita.quiz {
	 ...
	 *	@since  12.03.2008
	 */
	public class BlankStandard extends TextInput {
		...
		private var legacyFormat:TextFormat = new TextFormat("Verdana", "12", 0x000000);
        private var falconFormat:TextFormat = new TextFormat("Verdana", "12", 0xFFFFFF);
        ...
        public function setBlankType(type:String):void
        {
            if (type == "Legacy") {
                this.setStyle("textFormat", legacyFormat);
            } else {
                this.setStyle("textFormat", falconFormat);
            }
			// set up formats
