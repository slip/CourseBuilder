...
package com.davita.documents
{
	 ...
	 *	@since  13.11.2007
	 */
	public class PreviewWrapperGated extends MovieClip
	{
		/* ============= */
		/* = Variables = */
		/* ============= */
		 ...
		 *	@constructor
		 */
		public function PreviewWrapperGated()
		{	
		...
		{
			if (pageNum >= _highestPageNumViewed)
			{
				this._highestPageNumViewed  = pageNum;
				closeGate();
			}
		}
