...
{
  import com.davita.utilities.NumberUtilities;
  ...
  public class ArrayUtilities {
	...
	public static function addDistinct(aArray:Array, value:Array):Array
	{
		for (var i:int = 0; i<aArray.length; i++)
		{
			if (ArrayUtilities.equals(value, aArray[i], true, false))
			{
				trace(value + " is already in the array")
				return aArray;
			}
		}
		aArray.push(value);
