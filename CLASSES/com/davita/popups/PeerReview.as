...
package com.davita.popups
{
	...
	/**
	 *  PeerReview class provides the search panel
	 ...
	 *	@since  19.11.2007
	 */
	public class PeerReview extends MovieClip
	{
		...
		private function setUpTextFields():void {
			...
			trace(this.parent.xmlPages[this.parent.currentPage].@source);
            var filename:String = this.parent.xmlPages[this.parent.currentPage].@source.split("/")[1];
            var myLoadedSWF = this.parent.queue.rawContent as MovieClip;
